...
public class DeliveredOrdersFrame extends javax.swing.JFrame {
	 ...
	 */
	public DeliveredOrdersFrame(Kiosk kiosk) {
		this.kiosk = kiosk;
	...
	private void initOrders() {
		...
		orderModel = new PendingOrderTableModel(kiosk.getDeliveredOrders());
