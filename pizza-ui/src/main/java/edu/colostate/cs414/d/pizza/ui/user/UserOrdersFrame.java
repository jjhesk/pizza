...
import edu.colostate.cs414.d.pizza.ui.*;
...
public class UserOrdersFrame extends javax.swing.JFrame {
	 ...
	 */
	public UserOrdersFrame(Kiosk kiosk) {
		this.kiosk = kiosk;
                
		initComponents();
		initOrders();

        currentRewardPoints.setText(Integer.toString(kiosk.getLoggedInUser().getRewardPoints()));
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        currentRewardPoints = new JLabel();
        ...
        jLabel1.setText("Current Reward Points: ");

        currentRewardPoints.setText("0");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(currentRewardPoints)))
	...
	private void initOrders() {
		...
		orderModel = new PendingOrderTableModel(kiosk.getUserOrders());
    ...
    private JLabel currentRewardPoints;
