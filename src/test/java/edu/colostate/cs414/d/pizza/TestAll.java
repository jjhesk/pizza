...
@RunWith(Suite.class)
@Suite.SuiteClasses({ MenuManagerTest.class, OrderManagerTest.class, UserManagerTest.class, DailySpecialDatabaseControllerTest.class, MenuDatabaseControllerTest.class, OrderDatabaseControllerTest.class, UserDatabaseControllerTest.class, UtilityTest.class })
